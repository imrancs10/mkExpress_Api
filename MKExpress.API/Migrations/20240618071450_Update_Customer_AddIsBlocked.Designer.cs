...
namespace MKExpress.API.Migrations
{
    ...
    [Migration("20240618071450_Update_Customer_AddIsBlocked")]
    partial class Update_Customer_AddIsBlocked
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MKExpress.API.Models.Menu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MKExpress.API.Models.UserActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MKExpress.API.Models.UserRoleMenuMapper", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MKExpress.API.Models.ShipmentTracking", b =>
                {
                    b.HasOne("MKExpress.API.Models.User", "CommentByMember")
                        .WithMany()
            ...
            modelBuilder.Entity("MKExpress.API.Models.UserActivity", b =>
                {
                    ...
                    b.HasOne("MKExpress.API.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("MKExpress.API.Models.UserRoleMenuMapper", b =>
                {
                    ...
                    b.HasOne("MKExpress.API.Models.Menu", "Menu")
                        .WithMany()
