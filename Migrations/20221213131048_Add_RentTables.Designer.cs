...
namespace MKExpress.Web.API.Migrations
{
    ...
    [Migration("20221213131048_Add_RentTables")]
    partial class Add_RentTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MKExpress.API.Models.RentTransation", b =>
                {
                    b.HasOne("MKExpress.API.Models.RentDetail", "PaidByEmp")
                        .WithMany()
                        .HasForeignKey("PaidBy")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MKExpress.API.Models.RentDetail", "RentLocation")
                        .WithMany()
