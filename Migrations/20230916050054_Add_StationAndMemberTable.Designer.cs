...
namespace MKExpress.API.Migrations
{
    ...
    [Migration("20230916050054_Add_StationAndMemberTable")]
    partial class Add_StationAndMemberTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MKExpress.API.Models.CrystalPurchase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("CrystalPurchases");
                });

            modelBuilder.Entity("MKExpress.API.Models.CrystalPurchaseDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("CrystalPurchaseId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CrystalPurchaseId");

                    b.ToTable("CrystalPurchaseDetails");
                });

            modelBuilder.Entity("MKExpress.API.Models.CrystalPurchaseInstallment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("CrystalPurchaseInstallments");
                });

            modelBuilder.Entity("MKExpress.API.Models.CrystalStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("BalanceStockPieces")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("InStockPieces")
                        .HasColumnType("int");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit");

                    b.Property<int>("OutStock")
                        .HasColumnType("int");

                    b.Property<int>("OutStockPieces")
                        .HasColumnType("int");
                    ...
                    b.ToTable("CrystalStocks");
                });

            modelBuilder.Entity("MKExpress.API.Models.CrystalStockUpdateHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("NewPackets")
                        .HasColumnType("int");

                    b.Property<int>("NewPieces")
                        .HasColumnType("int");

                    b.Property<int>("OldPackets")
                        .HasColumnType("int");

                    b.Property<int>("OldPieces")
                        .HasColumnType("int");
                    ...
                    b.ToTable("CrystalStockUpdateHistories");
                });

            modelBuilder.Entity("MKExpress.API.Models.CrystalTrackingOut", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("CrystalTrackingOuts");
                });

            modelBuilder.Entity("MKExpress.API.Models.CrystalTrackingOutDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal>("ArticalLabourCharge")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("CrystalLabourCharge")
                        .HasColumnType("decimal(18,2)");

                    b.Property<bool>("IsAlterWork")
                        .HasColumnType("bit");
                    ...
                    b.Property<decimal>("ReleasePacketQty")
                        .HasColumnType("decimal(18,2)");

                    b.Property<int>("ReleasePieceQty")
                        .HasColumnType("int");

                    b.Property<int>("TrackingOutId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TrackingOutId");

                    b.ToTable("CrystalTrackingOutDetails");
                });
            ...
            modelBuilder.Entity("MKExpress.API.Models.MasterCrystal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MKExpress.API.Models.MasterWorkDescription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("MasterWorkDescriptions");
                });
            ...
            modelBuilder.Entity("MKExpress.API.Models.OrderWorkDescription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("OrderWorkDescriptions");
                });
            ...
            modelBuilder.Entity("MKExpress.API.Models.WorkTypeStatus", b =>
                {
                    ...
                    b.Property<string>("AddtionalNote")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MKExpress.API.Models.CrystalPurchaseDetail", b =>
                {
                    b.HasOne("MKExpress.API.Models.MasterCrystal", "MasterCrystal")
                        .WithMany("crystalPurchaseDetails")
                        .HasForeignKey("CrystalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MKExpress.API.Models.CrystalPurchase", "CrystalPurchase")
                        .WithMany("CrystalPurchaseDetails")
                        .HasForeignKey("CrystalPurchaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CrystalPurchase");

                    b.Navigation("MasterCrystal");
                });

            modelBuilder.Entity("MKExpress.API.Models.CrystalPurchaseInstallment", b =>
                {
                    b.HasOne("MKExpress.API.Models.CrystalPurchase", "CrystalPurchase")
                        .WithMany("CrystalPurchaseInstallments")
                        .HasForeignKey("CrystalPurchaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MKExpress.API.Models.CrystalStockUpdateHistory", b =>
                {
                    b.HasOne("MKExpress.API.Models.MasterCrystal", "Crystal")
                        .WithMany("CrystalStockUpdateHistories")
                        .HasForeignKey("CrystalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MKExpress.API.Models.CrystalTrackingOutDetail", b =>
                {
                    ...
                    b.HasOne("MKExpress.API.Models.OrderDetail", null)
                        .WithMany("CrystalTrackingOutDetails")
                        .HasForeignKey("OrderDetailId");

                    b.HasOne("MKExpress.API.Models.CrystalTrackingOut", "CrystalTrackingOut")
                        .WithMany("CrystalTrackingOutDetails")
                        .HasForeignKey("TrackingOutId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Crystal");

                    b.Navigation("CrystalTrackingOut");
                });
            ...
            modelBuilder.Entity("MKExpress.API.Models.MasterCrystal", b =>
                {
                    ...
                    b.HasOne("MKExpress.API.Models.MasterData", "Shape")
                        .WithMany()
            ...
            modelBuilder.Entity("MKExpress.API.Models.OrderWorkDescription", b =>
                {
                    b.HasOne("MKExpress.API.Models.OrderDetail", "OrderDetail")
                        .WithMany("OrderWorkDescriptions")
                        .HasForeignKey("OrderDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MKExpress.API.Models.MasterWorkDescription", "MasterWorkDescription")
                        .WithMany("OrderWorkDescriptions")
                        .HasForeignKey("WorkDescriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MasterWorkDescription");
            ...
            modelBuilder.Entity("MKExpress.API.Models.CrystalPurchase", b =>
                {
                    b.Navigation("CrystalPurchaseDetails");

                    b.Navigation("CrystalPurchaseInstallments");
                });

            modelBuilder.Entity("MKExpress.API.Models.CrystalTrackingOut", b =>
                {
                    b.Navigation("CrystalTrackingOutDetails");
                });
            ...
            modelBuilder.Entity("MKExpress.API.Models.MasterCrystal", b =>
                {
                    ...
                    b.Navigation("CrystalStocks");

                    b.Navigation("CrystalStockUpdateHistories");
                });
            ...
            modelBuilder.Entity("MKExpress.API.Models.MasterWorkDescription", b =>
                {
                    b.Navigation("OrderWorkDescriptions");
                });
